...
PYLINT_GOOD_NAMES := "_,i,j,k,d,f,s,x,ex,Run,pw,handle_GET,handle_POST,id,service_GET,service_POST,logger"
PYLINT_OPTS := -rn -d $(PYLINT_DISABLED_WARNINGS) --good-names=$(PYLINT_GOOD_NAMES) --max-line-length=120
